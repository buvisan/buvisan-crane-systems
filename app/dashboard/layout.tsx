...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuGroups = [
    ...
    { title: "SAHA (ÜRETİM)", allowedRoles: ["imalat", "üretim", "saha", "montaj", "proje","satın","çelik kasa"], items: [ { href: "/dashboard/production-screen", label: "Üretim Ekranı", icon: HardHat } ] },
