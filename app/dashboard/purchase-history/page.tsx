    ...
    return (
        <div className="flex flex-col gap-6 md:gap-8 max-w-[1400px] mx-auto w-full font-sans pb-10">
            ...
            <Dialog open={isFormViewerOpen} onOpenChange={setIsFormViewerOpen}>
                <DialogContent className="w-[95vw] max-w-4xl p-0 border-none bg-slate-50 shadow-2xl flex flex-col h-[90vh] max-h-[90vh] z-[200] overflow-hidden">
                    
                    <div className="flex-1 overflow-y-auto custom-scrollbar p-6 bg-slate-50 w-full">
                                    ...
                                    <tr>
                                        ...
                                        <td className="border border-black w-1/4 p-0 align-top text-[11px]">
                                            <table className="w-full h-full border-collapse">
                                                <tbody>
                                                    <tr><td className="border-b border-r border-black p-1.5 text-slate-700 font-bold bg-slate-50">Doküman No</td><td className="border-b border-black p-1.5 font-bold text-blue-700 uppercase">DOC-{viewingOrderGroup?.request_no?.replace(/\D/g, '') || '001'}</td></tr>
                                                    <tr><td className="border-b border-r border-black p-1.5 text-slate-700 font-bold bg-slate-50">Yayın Tarihi</td><td className="border-b border-black p-1.5 font-bold text-slate-900">{viewingOrderGroup?.created_at ? new Date(viewingOrderGroup.created_at).toLocaleDateString('tr-TR') : ''}</td></tr>
                                                    <tr><td className="border-b border-r border-black p-1.5 text-slate-700 font-bold bg-slate-50">Revizyon No</td><td className="border-b border-black p-1.5 font-bold">00</td></tr>
                                                    <tr><td className="border-r border-black p-1.5 text-slate-700 font-bold bg-slate-50">Revizyon Tarihi</td><td className="p-1.5 font-bold">--</td></tr>
                                                </tbody>
                                            </table>
                                        </td>
                                    </tr>
